...
# 1. Fix user_msg definition and process flow
old_part = """    # Encode annotated image (IMAGE 2 — for OCR block spatial reference)
    buf = io.BytesIO()
...
new_part = """    # Block list for Claude — absolute pixel coords in Claude's image space (sw×sh)
